...
function RouteComponent() {
    const { folderSlug } = useParams({ from: "/_auth/_projeto/$slug/financeiro/$folderSlug/" });
    ...
    return (
        <Container>
            ...
            <FolderNavigationBreadcrumbs currentPageName={folderSlug} prevPageName="Financeiro" />
